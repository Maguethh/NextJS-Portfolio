...
export default function LogoCarousel() {
  ...
  return (
    <div className="w-[80%] m-auto inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
